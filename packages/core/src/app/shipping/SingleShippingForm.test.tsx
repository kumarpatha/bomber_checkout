...
describe('SingleShippingForm', () => {
    ...
    it('renders a guest email field inside the shipping address form for guest shoppers', () => {
        renderSingleShippingFormComponent();

        expect(screen.getByLabelText('Email')).toBeInTheDocument();
    });

    it('renders a sign in link for guest shoppers', () => {
        renderSingleShippingFormComponent();

        expect(screen.getByRole('link', { name: /sign in/i })).toBeInTheDocument();
    });

    it('does not disable continue for guest shoppers when no shipping option is selected', () => {
        renderSingleShippingFormComponent();
